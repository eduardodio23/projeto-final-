...
from financeiro import calcular_custos, calcular_preco_final, calcular_projecoes

despesas = {"agua": 100, "luz": 200, "salarios": 3000, "impostos": 500}

total, custo = calcular_custos(despesas)
preco = calcular_preco_final(custo)
lucro_mensal, lucro_anual = calcular_projecoes(preco, custo)

print(total, custo, preco, lucro_mensal, lucro_anual)
